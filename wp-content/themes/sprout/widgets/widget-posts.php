		...
		function form( $instance ) {
			...
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id('style'); ?>" name="<?php echo $this->get_field_name('style'); ?>">
					<option value="small-left-thumbnail" <?php selected( $style, 'small-left-thumbnail' ); ?>>Small-Left Thumbnail</option>
					<option value="slider-carousel" <?php selected( $style, 'slider-carousel' ); ?>>Small Slider</option>
				</select>
			</p>
