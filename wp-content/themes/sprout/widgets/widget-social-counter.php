...
if ( ! defined( 'VW_CONST_SOCIAL_COUNTER_GOOGLE_API_KEY' ) ) define( 'VW_CONST_SOCIAL_COUNTER_GOOGLE_API_KEY', 'AIzaSyCNyDK8sPUuf9bTcG1TdFFLAVUfA1IDm38' ); // 60*60*4 = 4 Hrs cache
...
if ( ! class_exists( 'Vw_widget_social_counter' ) ) {
	class Vw_widget_social_counter extends WP_Widget {
			...
			if ( $vimeo ) {
				...
				?>
					<div class="vw-social-counter vw-social-counter-vimeo">
						<a class="vw-social-counter-icon" href="<?php echo esc_attr( $vimeo_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Subscribe our page', 'envirra' ) ?>" target="_blank"><i class="icon-social-vimeo"></i></a>
						<div class="vw-social-counter-counter">
			...
			if ( $soundcloud ) {
				...
				?>
					<div class="vw-social-counter vw-social-counter-soundcloud">
						<a class="vw-social-counter-icon" href="<?php echo esc_attr( $soundcloud_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Follow our Soundcloud', 'envirra' ) ?>" target="_blank"><i class="icon-social-soundcloud"></i></a>
						<div class="vw-social-counter-counter">
			...
			if ( $pinterest ) {
				...
				?>
					<div class="vw-social-counter vw-social-counter-pinterest">
						<a class="vw-social-counter-icon" href="<?php echo esc_attr( $pinterest_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Follow our pinterest', 'envirra' ) ?>" target="_blank"><i class="icon-social-pinterest"></i></a>
						<div class="vw-social-counter-counter">
			...
			if ( $instagram ) {
				...
				?>
					<div class="vw-social-counter vw-social-counter-instagram">
						<a class="vw-social-counter-icon" href="<?php echo esc_attr( $instagram_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Follow our instagram', 'envirra' ) ?>" target="_blank"><i class="icon-social-instagram"></i></a>
						<div class="vw-social-counter-counter">
			...
			if ( $vk ) {
				...
				?>
					<div class="vw-social-counter vw-social-counter-vk">
						<a class="vw-social-counter-icon" href="<?php echo esc_attr( $vk_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Follow our vk', 'envirra' ) ?>" target="_blank"><i class="icon-social-vk"></i></a>
						<div class="vw-social-counter-counter">
			...
			if ( $dribbble ) {
				...
				?>
					<div class="vw-social-counter vw-social-counter-dribbble">
						<a class="vw-social-counter-icon" href="<?php echo esc_attr( $dribbble_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Follow our Dribbble', 'envirra' ) ?>" target="_blank"><i class="icon-social-dribbble"></i></a>
						<div class="vw-social-counter-counter">
		...
		function form( $instance ) {
			...
			<!-- youtube username -->
			<p>
				<label for="<?php echo $this->get_field_id('youtube'); ?>">Youtube Username/Channel ID:</label>
			...
			<!-- vimeo channel name -->
			<p>
				<label for="<?php echo $this->get_field_id('vimeo'); ?>">Vimeo Channel Name/ID:</label>
			...
			<!-- vk group id -->
			<p>
				<label for="<?php echo $this->get_field_id('vk'); ?>">VK Group ID:</label>
