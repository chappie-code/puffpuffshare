 ...
 * Constants
 * -------------------------------------------------------------------------- */
if ( ! defined( 'VW_THEME_VERSION' ) ) define( 'VW_THEME_VERSION', '1.7.1' );
if ( ! defined( 'VW_THEME_NAME' ) ) define( 'VW_THEME_NAME', 'SPROUT' );
...
if ( ! defined( 'VW_CONST_THUMBNAIL_SIZE_CLASSIC' ) ) define( 'VW_CONST_THUMBNAIL_SIZE_CLASSIC', 'vw_two_third_thumbnail' );
if ( ! defined( 'VW_CONST_THUMBNAIL_SIZE_POST_BLOCK' ) ) define( 'VW_CONST_THUMBNAIL_SIZE_POST_BLOCK', 'vw_one_third_thumbnail' );
if ( ! defined( 'VW_CONST_THUMBNAIL_SIZE_POST_MASONRY' ) ) define( 'VW_CONST_THUMBNAIL_SIZE_POST_MASONRY', 'vw_one_third_thumbnail_no_crop' );
if ( ! defined( 'VW_CONST_THUMBNAIL_SIZE_POST_SMALL_LEFT_THUMBNAIL' ) ) define( 'VW_CONST_THUMBNAIL_SIZE_POST_SMALL_LEFT_THUMBNAIL', 'vw_small_squared_thumbnail' );
...
if ( class_exists( 'ReduxFramework' ) && version_compare( ReduxFramework::$_version, '3.5', '<' ) ) {
	require_once get_template_directory().'/inc/options-redux-3.4.php';
} else {
...
if ( is_admin() ) {
	...
	require_once get_template_directory().'/components/envato-wordpress-toolkit-library/connect-wordpress-toolkit.php';
		...
		<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
			<div id="comment-<?php comment_ID(); ?>" class="comment-body clearfix"> 
				...
				<div class="comment-text">
					...
					<div class="author">
						<div class="author-name vw-header-font"><?php echo get_comment_author_link(); ?></div>
						<div class="date">
