...
Redux::setSection( $vw_opt_name, array(
	...
	'fields'     => array(
		...
		array(
			...
			'subtitle' => 'Only visible when Site Layout is <strong>Boxed layout</strong>.',
			'default' => 0,
		),
		array(
			...
			'type' => 'background', 
			'title' => 'Ads Image',
			'subtitle' => 'Upload background image to be a background image.',
			...
			'output' => array( '.vw-bg-ads-enabled' ),
