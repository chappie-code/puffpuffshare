...
if ( ! function_exists( 'vw_register_required_plugins' ) ) {
	function vw_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				'name' => 'Sprout Theme Options Panel',
				'slug' => 'sprout-theme-options-panel',
				'required' => true,
				'version' => '1.3.0',
				'source' => get_template_directory_uri().'/plugins/sprout-theme-options-panel.zip',
			),

			array(
				'name' => 'Sprout Shortcodes',
				'slug' => 'sprout-shortcodes',
				'required' => true,
				'version' => '1.0.0',
				'source' => get_template_directory_uri().'/plugins/sprout-shortcodes.zip',
			),
