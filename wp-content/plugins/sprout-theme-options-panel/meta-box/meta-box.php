...
X-Plugin URI: http://www.deluxeblogtips.com/meta-box
X-Description: Create meta box for editing pages in WordPress. Compatible with custom post types since WP 3.0
X-Version: 4.3.8
X-Author: Rilwis
